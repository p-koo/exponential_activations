...
num_trials = 1
model_names = ['basset_exponential', 'basset_relu']
results_path = os.path.join('../results', 'task4')
size = 300

# save results to file
save_path = os.path.join(results_path, 'task4_filter_results.tsv')
with open(save_path, 'w') as f:
    ...
    for model_name in model_names:
            ...
            for trial in range(num_trials):
                ...
                # save path
                file_path = os.path.join(results_path, 'conv_filters', model_name, 'tomtom.tsv')
            ...
            print(trial_match_fraction)
            results[model_name] = {}
            results[model_name]['match_fraction'] = np.array(trial_match_fraction)
            results[model_name]['match_any'] = np.array(trial_match_any)
            
# pickle results
file_path = os.path.join(results_path, "task4_filter_results.pickle")
